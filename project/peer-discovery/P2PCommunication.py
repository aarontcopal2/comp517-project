...
class P2PCommunication(Node):

    # Python class constructor
    def __init__(self, host, port, id=None, callback=None, max_connections=0):
        super(P2PCommunication, self).__init__(host, port, id, callback, max_connections)
        print("P2PCommunication server started, host: "+ host + " port: " + str(port) + " id: " + str(id))
