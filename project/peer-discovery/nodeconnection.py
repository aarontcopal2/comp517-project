...
class NodeConnection(threading.Thread):
    ...
    def __init__(self, main_node, sock, id, host, port, connected_node_host, connected_node_port):
        ...
        self.connected_node_host = connected_node_host
        self.connected_node_port = int(connected_node_port)
